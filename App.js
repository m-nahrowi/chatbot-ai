	...
	return (
		<View style={styles.container}>
			...
			<View style={styles.header}>
				...
				<Text style={{ fontSize: 24, fontWeight: "800", color: "#323232" }}>ChatAI</Text>
			</View>
			...
			<View style={styles.searchBar}>
				<TextInput placeholder="Ask to AI" style={styles.input} value={inputText} onChangeText={(text) => setInputText(text)} selectionColor={"#323232"}></TextInput>
